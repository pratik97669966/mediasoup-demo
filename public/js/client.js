...
function shareRoomByEmail() {
    Swal.fire({
        ...
        preConfirm: () => {
            ...
            const email = '';
            const emailSubject = `Please join our Q UP App P2P Video Chat Meeting`;
...
function showAbout() {
    ...
    Swal.fire({
        ...
        <div id="about">
            ...
            <br /><br />
            <hr />
            <span>&copy; 2024 Q UP App P2P, all rights reserved</span>
            <hr />
        </div>
        `,
        showClass: { popup: 'animate__animated animate__fadeInDown' },
...
function leaveFeedback() {
    Swal.fire({
        ...
        text: 'Do you want to rate your Q UP App experience?',
        confirmButtonText: `Yes`,
        denyButtonText: `No`,
        showClass: { popup: 'animate__animated animate__fadeInDown' },
        hideClass: { popup: 'animate__animated animate__fadeOutUp' },
